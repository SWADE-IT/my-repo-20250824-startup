  ...
  en: {
    ...
    home: {
      hero: {
        ...
        subtitle:
          "Network troubleshooting, office IT system deployment, home WIFI or Internet issues fixing, home security and CCTV solutions",
      },
      highlights: {
  ...
  zh: {
    ...
    home: {
      hero: {
        ...
        subtitle:
          "网络故障排查、办公室 IT 系统部署、家庭 WIFI 或网络问题修复、家庭安防和监控解决方案",
      },
      highlights: {
        fast: "社区导向",
        budget: "预算可控",
